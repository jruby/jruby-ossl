...
protect_require 'test_certificate'
protect_require 'test_cipher'
protect_require 'test_integration'
protect_require 'test_java'
protect_require 'test_java_attribute'
protect_require 'test_java_bio'
protect_require 'test_java_mime'
protect_require 'test_java_pkcs7'
protect_require 'test_java_smime'
protect_require 'test_java_openssl_x509'
protect_require 'test_java_parse_certificate'
protect_require 'test_pkey'
protect_require 'test_x509store'
